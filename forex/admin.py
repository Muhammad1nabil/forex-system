...
class AccountAdmin(admin.ModelAdmin):
    list_display = ['account_id', 'Name', 'Age', 'email', 'mobile',
    ...
    search_fields = ['account_id', 'mobile', 'email']
    fieldsets = (
...
class TransactionAdmin(admin.ModelAdmin):
    list_display = ['id', 'account', 'transaction_type',
                    'amount_EGP', 'rate', 'amount_USD', 'active', 'paid']
    list_filter = ['transaction_type', 'active', 'paid']
...
class BalanceAdmin(admin.ModelAdmin):
    list_display = ['account', 'main_wallet_EGP', 'main_wallet_USD',
                    'balance', 'trading_result_last_week', 'total_achievement']
