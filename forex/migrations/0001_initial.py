# Generated by Django 2.2.20 on 2021-08-09 14:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Creation Date/Time')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Update Date/Time')),
                ('referral_bonus', models.FloatField(blank=True, null=True, verbose_name='Referral Bonus')),
                ('bonus_trans', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='forex.Transaction', verbose_name='Bonus Transaction')),
                ('customer', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='customer', to='forex.Account', verbose_name='Customer')),
